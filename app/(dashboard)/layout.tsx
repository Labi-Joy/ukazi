...
const studentMenuItems = [
    { icon: "solar:widget-bold", label: "Dashboard", href: "/dashboard" },
    { icon: "solar:notebook-bold", label: "Course", href: "/dashboard/courses" },
    { icon: "solar:users-group-rounded-bold", label: "Students", href: "/dashboard/students" },
    { icon: "solar:calendar-date-bold", label: "Schedule", href: "/dashboard/schedule" },
    { icon: "solar:chat-round-dots-bold", label: "Chat", href: "/dashboard/chat" },
]
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="text-right hidden sm:block">
                                <p className="text-sm font-bold font-raleway text-neutral-900">John Doe</p>
                                <p className="text-[10px] text-neutral-500 font-raleway">Student Account</p>
                            </div>
